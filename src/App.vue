<template>
  <div class="content">
    ...
    <div class="exampleNote">
      Привязали при помощи интерполяции переменную count: {{ count }}
    </div>
    <hr />
...
export default {
  ...
  data() {
    ...
    activationButton() {
      if (this.isButtonDisabled) { // получаем доступ к возвращаемому объекту функции дата через this. Пример на этой строчке 
